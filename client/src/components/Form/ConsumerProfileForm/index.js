...
import { TextField, Grid, Box, Typography, Button, Modal, Dialog, DialogActions, DialogContent, Switch, DialogTitle, FormControl, FormHelperText, FormControlLabel } from '@mui/material';
...
function ConsumerProfileForm() {
    ...
    const [isPrivate, setIsPrivate] = useState(user.isPrivate ? user.isPrivate : false);
    ...
    const saveButtonHandler = async () => {
        try {
            await axios.put(
                ...
                `${process.env.REACT_APP_API_SERVER}/api/consumer/${user?.id}`
                :
    ...
    return (
        ...
        <div>
            ...
            <Grid container direction="row" spacing={2} justifyContent="center">
                    ...
                    <Grid item>
                        <Button variant="text" color="error" onClick={() => setShow(true)}>Delete Account</Button>
                    </Grid>
            </Grid>
            <Modal open={show} onClose={() => setShow(false)}>
                <Box sx={style}>
                    <Grid container direction="column" spacing={2}>
                        <Grid item>
                            ...
                            <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                                Are you sure you would like to delete your account? You will lose all your data.
                            </Typography>
                        </Grid>
                        <Grid item />
                    </Grid>
                    <Grid container spacing={2} justifyContent="flex-end">
                        <Grid item>
                            <Button variant="text" color="error" onClick={deleteButtonHandler}>
                                Delete
                            </Button>
                        </Grid>
                        <Grid item>
            ...
            <Dialog open={edit} keepMounted onClose={() => setEdit(false)}>
                ...
                <DialogContent>
                    ...
                    <TextField 
                        ...
                        defaultValue={ description ? description : "Enter your self-introduction"}
                        rows={3}
                        fullWidth
                        multiline
                    ...
                    <FormControl>
                        ...
                        />
                        <FormHelperText>Other player won't be able to see your account if you set it to private.</FormHelperText>
                    </FormControl>
                </DialogContent>
                <DialogActions>
